        ...
        <v-card-text>
          <center>
            ...
            <v-avatar color="indigo" size="50px">
              <span class="white--text"><b>{{ mappingStatusProgressPercent }}%</b></span>
            </v-avatar>
            </v-progress-circular>
            <v-progress-linear
            indeterminate
		...
		<v-layout column>
			...
			<v-flex xs1>
	          ...
	          >
	            <v-layout column>
	              <v-flex xs1>
	                <v-icon light >thumb_up</v-icon><b>MOH Matched</b>
	              </v-flex>
	              <v-flex xs1 align-center>
	                <center><b>{{$store.state.totalAllMapped}}/{{$store.state.mohTotalAllRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	                  ...
	                  :size="65"
	                  :width="8"
	                  :value="mohPercentMapped"
	                  color="yellow"
	                >
	                  <font color="white"><b>{{ mohPercentMapped }}%</b></font>
	                </v-progress-circular>
	              </center>
	              </v-flex>
	            </v-layout>
	            ...
	            color="red"
	            text-color='white'
	            style='height:138px;width:144px'
	          >
	            <v-layout column>
	              <v-flex xs1>
	                <v-icon light >thumb_up</v-icon><b>MOH Not Mapped</b>
	              </v-flex>
	              <v-flex xs1 align-center>
	                <center><b>{{$store.state.mohTotalAllNotMapped}}/{{$store.state.mohTotalAllRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	                  ...
	                  :size="65"
	                  :width="8"
	                  :value="mohPercentNotMapped"
	                  color="yellow"
	                >
	                  <font color="white"><b>{{ mohPercentNotMapped }}%</b></font>
	                </v-progress-circular>
	              </center>
	              </v-flex>
	            </v-layout>
	          ...
	          >
	            <v-layout column>
	              <v-flex xs1>
	                <v-icon light >thumb_down</v-icon><b>MOH No Match</b>
	              </v-flex>
	              <v-flex xs1 align-center>
	                <center><b>{{$store.state.totalAllNoMatch}}/{{$store.state.mohTotalAllRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	          ...
	          >
	            <v-layout column>
	              <v-flex xs1>
	                <v-icon light >notification_important</v-icon><b>MOH Flagged</b>
	              </v-flex>
	              <v-flex xs1 align-center>
	                <center><b>{{$store.state.totalAllFlagged}}/{{$store.state.mohTotalAllRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	          ...
	          >
	            <v-layout column>
	              <v-flex xs1>
	                <v-icon light >thumb_up</v-icon><b>DATIM Matched</b>
	              </v-flex>
	              <v-flex xs1 align-center>
	                <center><b>{{$store.state.totalAllMapped}}/{{$store.state.datimTotalAllRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	                  ...
	                  :size="65"
	                  :width="8"
	                  :value="datimPercentMapped"
	                  color="yellow"
	                >
	                  <font color="white"><b>{{ datimPercentMapped }}%</b></font>
	                </v-progress-circular>
	              </center>
	              </v-flex>
	            </v-layout>
	          ...
	          >
	            <v-layout column>
	              <v-flex xs1>
	                <v-icon light >notification_important</v-icon><b>DATIM Flagged</b>
	              </v-flex>
	              <v-flex xs1 align-center>
	                <center><b>{{$store.state.totalAllFlagged}}/{{$store.state.datimTotalAllRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	          ...
	          >
	            <v-layout column>
	              ...
	              <v-flex xs1 align-center>
	                <center><b>{{totalMapped}}/{{totalRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	                  ...
	                  :size="65"
	                  :width="8"
	                  :value="mohPercentMappedLevel"
	                  color="yellow"
	                >
	                  <font color="white"><b>{{ mohPercentMappedLevel }}%</b></font>
	                </v-progress-circular>
	              </center>
	              </v-flex>
	            </v-layout>
	          ...
	          >
	            <v-layout column>
	              ...
	              <v-flex xs1 align-center>
	                <center><b>{{totalNoMatch}}/{{totalRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	                  ...
	                  :size="65"
	                  :width="8"
	                  :value="mohPercentNoMatchLevel"
	                  color="yellow"
	                >
	                  <font color="white"><b>{{ mohPercentNoMatchLevel }}%</b></font>
	                </v-progress-circular>
	              </center>
	              </v-flex>
	            </v-layout>
	          ...
	          >
	            <v-layout column>
	              ...
	              <v-flex xs1 align-center>
	                <center><b>{{totalFlagged}}/{{totalRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	            ...
	            color="green"
	            text-color='white'
	            style='height:138px;width:143px'
	          >
	            <v-layout column>
	              <v-flex xs1>
	                <v-icon light >thumb_down</v-icon><b>MOH Not Mapped</b>
	              </v-flex>
	              <v-flex xs1 align-center>
	                <center><b>{{totalNotMapped}}/{{totalRecords}}</b></center>
	              </v-flex>
	              <v-flex xs1>
	                <center>
	                <v-progress-circular
	                  ...
	                  :size="65"
	                  :width="8"
	                  :value="mohPercentNotMappedLevel"
	                  color="yellow"
	                >
	                  <font color="white"><b>{{ mohPercentNotMappedLevel }}%</b></font>
	                </v-progress-circular>
	              </center>
	              </v-flex>
	            </v-layout>
