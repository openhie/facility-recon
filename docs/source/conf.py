...
htmlhelp_basename = 'FacilityMatchdoc'
...
latex_documents = [
    (master_doc, 'FacilityMatch.tex', 'Facility Reconciliation Tool documentation',
...
man_pages = [
    (master_doc, 'facilitymatch', 'Facility Reconciliation Tool documentation',
     [author], 1)
]
